...
public interface AlertDAO {
    @SqlUpdate("INSERT INTO Alert (title, message, severity, starting, ending, status, created) " +
            "VALUES (:title, :message, :severity, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP, 0, CURRENT_TIMESTAMP)")
    @GetGeneratedKeys
